                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.states.update", [$state->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $state->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('statut') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="statut" id="statut" value="{{ old('statut', $state->statut) }}" step="1">
