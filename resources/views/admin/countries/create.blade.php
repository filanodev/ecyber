                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.countries.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('phonecode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phonecode" id="phonecode" value="{{ old('phonecode', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('currency') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="currency" id="currency" value="{{ old('currency', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('taux') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="taux" id="taux" value="{{ old('taux', '1') }}" step="0.01">
                            @if($errors->has('taux'))
                        ...
                        <div class="form-group {{ $errors->has('timezones') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="timezones" id="timezones" value="{{ old('timezones', '') }}">
