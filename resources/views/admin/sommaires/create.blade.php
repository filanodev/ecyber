        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.sommaire.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.sommaires.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('identifiant') ? 'has-error' : '' }}">
                            <label for="identifiant">{{ trans('cruds.sommaire.fields.identifiant') }}</label>
                            <input class="form-control" type="text" name="identifiant" id="identifiant" value="{{ old('identifiant', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('montant') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="montant" id="montant" value="{{ old('montant', '0') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('montant_payer') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="montant_payer" id="montant_payer" value="{{ old('montant_payer', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('type_payement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="type_payement" id="type_payement" value="{{ old('type_payement', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('ask_payement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ask_payement" id="ask_payement" value="{{ old('ask_payement', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('confirm_payement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="confirm_payement" id="confirm_payement" value="{{ old('confirm_payement', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('commentaire') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="commentaire" id="commentaire">{{ old('commentaire') }}</textarea>
