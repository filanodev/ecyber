                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.cities.update", [$city->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="latitude" id="latitude" value="{{ old('latitude', $city->latitude) }}" step="0.00000001">
                        ...
                        <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="longitude" id="longitude" value="{{ old('longitude', $city->longitude) }}" step="0.00000001">
